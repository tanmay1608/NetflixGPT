  ...
  return (
    <div className="w-full h-14 bg-gray-700 bg-opacity-50 fixed z-40 bottom-0 md:hidden">
      <div className="flex text-white justify-between items-center h-full">
        <div>
          <button
            className={`flex justify-center items-center w-10 h-10 m-4 bg-gray-700 bg-opacity-50 hover:bg-opacity-70  font-semibold text-white  rounded-full cursor-pointer `}
        ...
        <div>
          <button
            className={`flex justify-center items-center w-10 h-10 m-4 bg-gray-700 bg-opacity-50 hover:bg-opacity-70  font-semibold ${
