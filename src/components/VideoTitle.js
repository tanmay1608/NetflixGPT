...
const VideoTitle = ({ title, overview, id }) => {
  ...
  return (
    <div className="hidden sm:block absolute  md:pt-[17%] sm:pt-[10%]  md:px-24 sm:px-12 sm:bg-gradient-to-r sm:from-black w-screen sm:aspect-video z-10">
      <h1 className="hidden sm:block text-3xl w-[400px] md:text-5xl font-bold text-white md:w-[600px]">
        {title}
      </h1>
      <p className=" hidden sm:block text-base py-6 text-white w-[400px] md:w-[600px] ">
        {overview}
      </p>
      <div className="flex ">
        <Link to={"/browse/" + id}>
