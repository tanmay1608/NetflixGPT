...
const VideoTitle = ({title,overview}) => {
  return (
    <div className='absolute pt-[25%]  px-24 bg-gradient-to-r from-black w-screen aspect-video z-10'>
      <h1 className='text-6xl font-bold text-white w-2/4'>{title}</h1>
      <p className='text-lg py-6 text-white w-2/4'>{overview}</p>
      <div className='flex'>
